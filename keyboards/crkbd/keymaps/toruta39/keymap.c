...
#define KC_GUIL  G(KC_LEFT)
#define KC_GUIR  G(KC_RIGHT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                   LGUI, LOWER,   SPC,     BSPC, RAISE,  RALT \
                              //`--------------------'  `--------------------'
  ),
  ...
  [_LOWER] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
        ESC,  EXLM,    AT,  LPRN,  RPRN,  DQUO,                   AMPR,  GUIL,    UP,  GUIR, XXXXX, XXXXX,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      CTLTB,  HASH,   DLR,  LCBR,  RCBR,  QUOT,                   ASTR,  LEFT,  DOWN, RIGHT, XXXXX, XXXXX,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       LSFT,  PERC,  CIRC,  LBRC,  RBRC,   GRV,                   UNDS,  MINS,   EQL,  PLUS,  TILD, XXXXX,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                   LGUI, LOWER,   SPC,      DEL, RAISE,  RALT \
                              //`--------------------'  `--------------------'
  ),
